...
public class RangedProjectilePool : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError(
                "RangedProjectilePool requires a projectile prefab.",
                this);
    ...
    private static void OnGetFromPool(GameObject projectile)
    {
    ...
    private static void OnDestroyPooledProjectile(GameObject projectile)
    {
        Destroy(projectile);
    }
